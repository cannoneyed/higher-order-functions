...
const txt = fs.readFileSync(path.resolve(__dirname, './mathematica-output.txt'), 'utf8');
...
fs.writeFileSync(path.resolve(__dirname, './data.json'), JSON.stringify(data), 'utf-8');
